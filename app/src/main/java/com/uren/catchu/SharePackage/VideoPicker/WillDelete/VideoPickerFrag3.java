...
public class VideoPickerFrag3 extends Fragment implements MediaRecorder.OnInfoListener, TextureView.SurfaceTextureListener {
    ...
    private void initUI() {
        ...
        //mCamera = (CameraManager) getActivity().getSystemService(Context.CAMERA_SERVICE);
    }
