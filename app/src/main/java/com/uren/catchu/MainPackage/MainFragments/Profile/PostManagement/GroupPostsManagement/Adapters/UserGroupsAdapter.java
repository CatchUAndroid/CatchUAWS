package com.uren.catchu.MainPackage.MainFragments.Profile.PostManagement.GroupPostsManagement.Adapters;
...
public class UserGroupsAdapter extends RecyclerView.Adapter<UserGroupsAdapter.MyViewHolder> {
    ...
    public UserGroupsAdapter(Context context, String postId) {
    ...
    @Override
    public UserGroupsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.single_post_item_comment, parent, false);

        return new UserGroupsAdapter.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(final UserGroupsAdapter.MyViewHolder holder, final int position) {
