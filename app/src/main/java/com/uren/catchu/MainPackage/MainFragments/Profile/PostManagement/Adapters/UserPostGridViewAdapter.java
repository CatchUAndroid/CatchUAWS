...
public class UserPostGridViewAdapter extends RecyclerView.Adapter<UserPostGridViewAdapter.MyViewHolder> {

    private Context context;
    private List<String> textList;

    public UserPostGridViewAdapter(Context context, List<String> textList) {
