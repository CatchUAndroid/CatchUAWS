...
public class ProfilePostAdapter extends RecyclerView.Adapter {
    ...
    public ProfilePostAdapter(Activity activity, Context context, BaseFragment.FragmentNavigation fragmentNavigation , User selectedUser, int pageCnt) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            viewHolder = new ProfilePostAdapter.MyViewHolder(itemView);
        } else {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.progressbar_item, parent, false);

            viewHolder = new ProfilePostAdapter.ProgressViewHolder(v);
        }
        return viewHolder;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ProfilePostAdapter.MyViewHolder) {
            Post post = postList.get(position);
            ((ProfilePostAdapter.MyViewHolder) holder).setData(post, position);
        } else {
            ((ProfilePostAdapter.ProgressViewHolder) holder).progressBar.setIndeterminate(true);
        }
