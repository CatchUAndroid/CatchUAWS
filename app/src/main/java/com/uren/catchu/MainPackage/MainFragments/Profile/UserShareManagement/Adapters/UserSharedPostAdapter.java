...
public class UserSharedPostAdapter extends RecyclerView.Adapter<UserSharedPostAdapter.MyViewHolder> {

    private Context context;
    private List<String> textList;

    public UserSharedPostAdapter(Context context, List<String> textList) {
