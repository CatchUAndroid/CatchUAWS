 ...
 */
public class UserPostItemAnimator extends DefaultItemAnimator {
        ...
        if (changeFlags == FLAG_CHANGED) {
            for (Object payload : payloads) {
                if (payload instanceof String) {
                    return new UserPostItemHolderInfo((String) payload);
                }
            }
        }
...
*/
    ...
    */
    ...
    public static class UserPostItemHolderInfo extends ItemHolderInfo {
        public String updateAction;

        public UserPostItemHolderInfo(String updateAction) {
