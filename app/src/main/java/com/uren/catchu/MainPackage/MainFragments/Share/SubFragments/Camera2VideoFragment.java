...
public class Camera2VideoFragment extends BaseFragment implements View.OnClickListener {
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture,
            ...
            if (permissionModule.checkCameraPermission() && permissionModule.checkRecordAudioPermission()) {
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // UI
                            toggleRecordingButton.setText(R.string.stop);
    ...
    private void stopRecordingVideo() {
        ...
        toggleRecordingButton.setText(R.string.record);
        // Stop recording
        mMediaRecorder.stop();
