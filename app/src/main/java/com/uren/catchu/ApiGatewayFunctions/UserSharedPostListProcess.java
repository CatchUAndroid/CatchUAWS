...
public class UserSharedPostListProcess extends AsyncTask<Void, Void, PostListResponse> {
    ...
    public UserSharedPostListProcess(Context context, OnEventListener callback, String userId,
                                     String uid,
                                     String longitude,
                                     String perpage,
                                     String latitude,
    ...
    protected PostListResponse doInBackground(Void... voids) {
        ...
        try {
            ...
            PostListResponse postListResponse = instance.client.usersUidPostsGet(userId, uid, token, longitude, perpage, latitude, radius, page, privacyType);
